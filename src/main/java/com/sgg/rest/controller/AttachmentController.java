...
public class AttachmentController {
	...
	public ResponseEntity<Map<String,Object>> createAttachment(@RequestParam String code,@RequestBody Attachment attachment) {
		boolean res =attachmentService.createAttachment(code, attachment);
